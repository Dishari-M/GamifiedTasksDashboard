  ...
  return (
    <div className="focus-quest-saved focus-reward-panel" data-testid="focus-quest-saved">
      ...
      <div>
        ...
        <p>{formatMinutes(savedQuest.focusMinutes)} logged toward a {formatMinutes(savedQuest.focusTargetMinutes)} target. {percent}% complete.</p>
        <div className="progress-track focus-saved-progress" aria-label="Saved session quest progress">
          <span className="progress-fill" style={{ width: `${percent}%` }} />
        </div>
      </div>
      <span className="quest-xp-chip"><Trophy size={15} weight="fill" aria-hidden="true" /> {savedQuest.rewardXp} XP available</span>
