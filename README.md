...
- If AI is unavailable, backend services are designed to keep the app usable through deterministic scoring and fallback behavior.
...
| --- | --- | --- |
| `DEVQUEST_DATA_MODE` | `oracle` | Use Oracle ADB repositories. |
